...
import static com.softwaremill.pekkohttpsession.javadsl.SessionTransports.HeaderST;
...
public class RefreshableTest extends HttpSessionAwareDirectivesTest {
    ...
    public void shouldTouchTheSession_KeepingTheRefreshTokenIntact_UsingCookies() {
        ...
        // 70 seconds from the initial the session, only the touched one should work
