...
class CheckHeader[T] private[pekkohttpsession] (implicit val manager: SessionManager[T]) extends CsrfCheckMode[T]
class CheckHeaderAndForm[T] private[pekkohttpsession] (implicit
