...
object SessionSerializer {
  ...
  private[pekkohttpsession] def urlEncode(s: String): String = URLEncoder.encode(s, "UTF-8")
  private[pekkohttpsession] def urlDecode(s: String): String = URLDecoder.decode(s, "UTF-8")
}
